...
export default function Contact() {
  return (
    <section className="mx-auto my-8 max-w-6xl rounded-2xl overflow-hidden bg-[#111827] shadow-2xl">
      <div className="grid grid-cols-1 md:grid-cols-2">
        {/* Left info panel */}
        <div className="relative bg-gradient-to-br from-[#232946] via-[#161b22] to-[#232946] px-10 py-14 flex flex-col justify-between min-h-[500px]">
          <div>
        ...
        {/* Right form panel */}
        <div className="bg-[#161b22] px-10 py-14 flex items-center">
